...
def add_box( points, x, y, z, width, height, depth ):
    ...
    add_edge(points, vertices[3][0], vertices[3][1], vertices[3][2], vertices[1][0], vertices[1][1], vertices[1][2]) #complete front
    ...
    add_edge(points, vertices[5][0], vertices[5][1], vertices[5][2], vertices[7][0], vertices[7][1], vertices[7][2]) #complete back
...
def add_sphere( points, cx, cy, cz, r, step ):
    ...
    for dot in new_points:
        add_edge(points, dot[0], dot[1], dot[2], dot[0] + 1, dot[1] + 1, dot[2] + 1)
